                ...
                <el-table-column label="操作" width="180" align="center">
                    <template slot-scope="scope">
                        <el-button v-if="scope.row.edit" type="success" size="small" icon="el-icon-circle-check-outline"
                                   @click="saveEdit(scope.$index, scope.row)">确定
                        </el-button>
                        <el-button v-if="scope.row.edit" size="small" type="warning" @click="cancelEdit(scope.row)">取消
                        </el-button>
                        <el-button v-else type="text" icon="el-icon-edit" @click="handleEdit(scope.$index, scope.row)">
                            编辑
                        </el-button>
        ...
        <el-dialog title="编辑" :visible.sync="editVisible" width="30%">
            <el-form ref="articleCategory" :model="articleCategory" label-width="100px">
                ...
                <el-form-item label="是否可用" prop="status">
                    <el-switch v-model="articleCategory.frozen"
                               :active-text="articleCategory.frozen ? '可用' : '不可用'"></el-switch>
                </el-form-item>
            </el-form>
            <span slot="footer" class="dialog-footer">
                <el-button @click="editVisible = false">取 消</el-button>
                <el-button type="primary" :loading="loading" @click="saveAdd">确 定</el-button>
            </span>
        </el-dialog>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            saveEdit(index, articleCategory) {
                ArticleCategoryApi.save(articleCategory).then((res) => {
                    if (res.error === false) {
